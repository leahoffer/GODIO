...
public class ModificarCuentaCorriente {
	...
	private String rol;
    private ModificarCuentaCorriente vent;
	...
	public ModificarCuentaCorriente(ClienteDTO cliente) {
		...
		contentPane.add(lblNombre2);
		 ...
		 saldo.setText(String.valueOf(cliente.getCuentaCorriente().getSaldo()));
		 ...
		 limite.setText(String.valueOf(cliente.getCuentaCorriente().getLimite()));
